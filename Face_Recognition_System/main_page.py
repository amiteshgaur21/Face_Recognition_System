...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        b4=Button(my_frame,image=self.photo_img5,cursor="hand2",command = self.Help_function)
        b4.place(x=650,y=60,width=150,height=150)

        b4_1=Button(my_frame,text="Help",bg='#041c3e',fg='#F5F5DC',cursor="hand2", font=('Microsoft YaHei',10,'bold'),command = self.Help_function)
        ...
        b7=Button(my_frame,image=self.photo_img8,cursor="hand2",command=self.Developer_function)
        b7.place(x=450,y=350,width=150,height=150)

        b7_1=Button(my_frame,text="Developer",bg='#041c3e',fg='#F5F5DC',cursor="hand2", font=('Microsoft YaHei',10,'bold'),command=self.Developer_function)
